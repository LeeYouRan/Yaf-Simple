...
if (!function_exists('message')) {
     ...
     * @date 2019/5/28
     */
    function message($msg = "操作成功", $success = true, $data = [], $count = 0, $code = 0)
    {
...
//        \Modules\Ifm\Models\ApiRequestModel::write();
        return $result;
    }
}
...
if (!function_exists('upload_image')) {
    ...
    function upload_image($request, $form_name = 'file')
    {
        ...
        if ($size > 50 * 1024 * 1024) {
            return message("文件大小超过了50M", false);
        }

        // 文件后缀校验
        $ext_arr = array('jpg', 'jpeg', 'png', 'gif','mp4','pdf');
...
if (!function_exists('upload_file')) {
    ...
    function upload_file($request, $form_name = 'file')
    {
        ...
        // 允许上传的文件后缀
        $file_exts = array('xls', 'xlsx', 'csv','doc', 'docx', 'docm', 'dot', 'dotx', 'dotm', 'word','xls', 'xlsx', 'xlsm', 'xltx', 'xltm', 'xlsb', 'xlam', 'excel','pptx', 'pptm', 'ppsx', 'potx', 'potm', 'ppam', 'ppt','pdf');
